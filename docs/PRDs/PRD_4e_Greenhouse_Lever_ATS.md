# PRD: Phase 4e — Greenhouse / Lever / ATS Extractor

## 0. Status: ⏭️ PLANNED

## 1. Problem
Adding Greenhouse_Lever_ATS expands job coverage beyond LinkedIn.

## 2. Goals
- ✅ Implement `BaseExtractor` contract for Greenhouse_Lever_ATS
- ✅ Multi-language buttons if applicable
- ✅ Handle platform-specific quirks: Form-based, easier than job boards

## 3. Tech Spec
- `packages/extractors/greenhouse.py` (new)
- Register in `EXTRACTOR_REGISTRY` in runner.py
- New config block: `platforms.greenhouse_lever_ats.*`
- New env vars: `GREENHOUSE_LEVER_ATS_EMAIL`, `GREENHOUSE_LEVER_ATS_PASSWORD`
...
## 8. Risks
- Platform-specific: Form-based, easier than job boards
