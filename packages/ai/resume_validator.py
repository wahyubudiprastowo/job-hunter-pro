"""
Resume Anti-Hallucination Validator (PATCH 11).

CHANGES from 9.1:
- COMMON_KNOWLEDGE_TERMS — don't flag generic concepts as "invented"
- Stricter forbidden phrase check
- Better tech detection (lookup by line)
"""
...
# PATCH 11: Common-knowledge terms — don't count as "invented" since they're
# generic concepts that any DevOps/Cloud engineer's experience implicitly covers
COMMON_KNOWLEDGE_TERMS = {
    "cloud",       # Anyone in cloud space implicitly uses "cloud"
    "container",   # Generic concept (vs Docker/K8s being specific)
    "monitor",     # Generic concept (vs Prometheus being specific)
    "ci-cd",       # Umbrella term
    "iac",         # Umbrella term
    "sre",         # Umbrella term
    "auto-scaling", # Generic capability
    "git-ops",     # Generic methodology
...
def validate_tailored(
    ...
    # PATCH 11: Filter out common-knowledge terms from new_tech
