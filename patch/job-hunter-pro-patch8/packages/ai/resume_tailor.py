...
4. NEVER invents new skills/experience (anti-hallucination)
...
TAILOR_SYSTEM_PROMPT = """You are an expert resume tailoring assistant.
...
def generate_tailored_resume(
    ...
    # Build AI prompt
    sys_prompt = TAILOR_SYSTEM_PROMPT.format(
