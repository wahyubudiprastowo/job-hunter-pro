"""
Resume Anti-Hallucination Validator (PATCH 9.1).

CHANGES from 9.0:
- _normalize_variants: handles "load balancer/balancing", "monitoring/monitor"
- Synonym map for common DevOps term variants  
- Less false positives on legitimate rephrasing
"""
...
TECH_PATTERNS = {
    ...
    "networking": [
        ...
        # PATCH 9.1: replaced "load balancer" with variants below
    ],
    "storage": [
...
# PATCH 9.1: Variant groups — these all map to the same canonical concept
VARIANT_GROUPS = [
...
def _canonicalize_terms(terms: set) -> set:
    """PATCH 9.1: Map variants to canonical form."""
    canonical = set()
    for t in terms:
...
def validate_tailored(
    ...
    # PATCH 9.1: canonicalize before comparing
