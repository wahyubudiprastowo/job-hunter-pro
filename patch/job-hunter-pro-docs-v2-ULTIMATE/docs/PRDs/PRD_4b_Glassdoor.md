# PRD: Phase 4b — Glassdoor Extractor

## 0. Status: ⏭️ PLANNED

## 1. Problem
Adding Glassdoor expands job coverage beyond LinkedIn.

## 2. Goals
- ✅ Implement `BaseExtractor` contract for Glassdoor
- ✅ Multi-language buttons if applicable
- ✅ Handle platform-specific quirks: Reuses Indeed login chain

## 3. Tech Spec
- `packages/extractors/glassdoor.py` (new)
- Register in `EXTRACTOR_REGISTRY` in runner.py
- New config block: `platforms.glassdoor.*`
- New env vars: `GLASSDOOR_EMAIL`, `GLASSDOOR_PASSWORD`
...
## 8. Risks
- Platform-specific: Reuses Indeed login chain
